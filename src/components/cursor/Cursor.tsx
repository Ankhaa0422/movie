...
export const Cursor: FC<CursorProps> = ({
    ...
    function cursorEvent() {
        const sizeElements = (document.querySelectorAll('[data-cursor-size]') as unknown) as NodeListOf<HTMLElement>;
        const textElements = (document.querySelectorAll('[data-cursor-text]') as unknown) as NodeListOf<HTMLElement>;
        const colorElements = (document.querySelectorAll('[data-cursor-color]') as unknown) as NodeListOf<HTMLElement>;
        const backgroundImageElements = (document.querySelectorAll('[data-cursor-background-image]') as unknown) as NodeListOf<HTMLElement>;
        ...
        window.addEventListener('mousemove', e => {setFromEvent(e)});
        ...
        textElements.forEach(el => {
            el.addEventListener('mouseenter', (e: MouseEvent) => {
                ...
                cursorInner.current.innerHTML = `${e.target.dataset['cursorText']}`;
        ...
        blurElements.forEach(el => {
            el.addEventListener('mouseenter', (e: MouseEvent) => {
                if (e.target instanceof HTMLElement && cursor.current) {
                    gsap.to(`#${cursor.current.id}`, {
                        backdropFilter: `blur(${e.target.dataset['cursorBackdropblur']})`,
                        duration: colorAnimationDuration,
                        ease: colorAnimationEase,
                    });
                }
    ...
    return (
        ...
        ref={cursor}
        id={'c-cursor'}
        className={`c-cursor ${className} z-[999999]`}
        style={{
            width: cursorSize,
            height: cursorSize,
